...
**Purpose**: REST API analysing US domestic flight disruptions (2023-2024) for operational dashboards and research
tools.

**Problem**: Airlines/airports need clear, actionable insights into delay patterns, cancellation causes, and
