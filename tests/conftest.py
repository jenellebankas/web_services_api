...
VALUES
  ...
  ('2024-01-15', 'AA', 100, 'LAX', 'JFK',
   '2024-01-15 08:00', '2024-01-15 08:25', '2024-01-15 16:00', '2024-01-15 16:30',
   25, 30, 1, 1, 0, NULL, 0,
   30, 0, 0, 0, 0, 2475),

  -- AA 100: leg 2  JFK→ORD  (same flight number, same date — ripple chain)
  ('2024-01-15', 'AA', 100, 'JFK', 'ORD',
   '2024-01-15 18:00', '2024-01-15 18:20', '2024-01-15 20:00', '2024-01-15 20:25',
   20, 25, 1, 1, 0, NULL, 0,
   0, 0, 25, 0, 0, 740),

  -- Normal LAX flight (on-time)
  ('2024-01-16', 'UA', 200, 'LAX', 'SFO',
   '2024-01-16 09:00', '2024-01-16 09:02', '2024-01-16 10:30', '2024-01-16 10:28',
   2, -2, 0, 0, 0, NULL, 0,
   0, 0, 0, 0, 0, 337),

  -- LAX cancellation — carrier (A)
  ('2024-01-17', 'AA', 300, 'LAX', 'DFW',
   '2024-01-17 07:00', NULL, '2024-01-17 12:00', NULL,
   NULL, NULL, NULL, NULL, 1, 'A', 0,
   NULL, NULL, NULL, NULL, NULL, 1235),

  -- LAX cancellation — weather (B)
  ('2024-01-18', 'DL', 400, 'LAX', 'SEA',
   '2024-01-18 06:00', NULL, '2024-01-18 08:30', NULL,
   NULL, NULL, NULL, NULL, 1, 'B', 0,
   NULL, NULL, NULL, NULL, NULL, 954),

  -- 2023 row for year-over-year tests
  ('2023-06-01', 'AA', 500, 'LAX', 'JFK',
   '2023-06-01 10:00', '2023-06-01 10:35', '2023-06-01 18:00', '2023-06-01 18:40',
   35, 40, 1, 1, 0, NULL, 0,
   20, 10, 10, 0, 0, 2475),

  -- JFK delayed flight (late aircraft cause — for cause breakdown)
  ('2024-02-01', 'DL', 600, 'JFK', 'MIA',
   '2024-02-01 11:00', '2024-02-01 11:50', '2024-02-01 14:00', '2024-02-01 14:55',
   50, 55, 1, 1, 0, NULL, 0,
   0, 0, 0, 0, 55, 1090),

  -- ORD on-time flight (gives ORD a node in the graph)
  ('2024-02-02', 'UA', 700, 'ORD', 'DEN',
   '2024-02-02 13:00', '2024-02-02 13:05', '2024-02-02 15:00', '2024-02-02 14:58',
   5, -2, 0, 0, 0, NULL, 0,
   0, 0, 0, 0, 0, 920)
;
"""
